...
int main(){
	...
	t.root = t.insertion_Faculty(t.root, 1001, "Ram", "NIL", "17300", "Male", "0300-0000001", "HOD", "ram@cumail.com", "PHD", 50, "Chandigarh","AIT","Active");
	t.root = t.insertion_Faculty(t.root, 1002, "Sham", "NIL", "17301", "Male", "0301-5267432", "Assitant Professor", "sham@cumail.com", "POST_DOC",48, "Chandigarh","AIT", "Active");
	t.root = t.insertion_Faculty(t.root, 1003, "Ankit", "NIL", "17302", "Male", "0322-3084357", "Assistant Professor", "ankit@cumail.com", "MS", 48, "Chandigarh", "AIT", "Active");
	t.root = t.insertion_Faculty(t.root, 1004, "Ankur", "NIL", "17303", "Male", "0340-1234567", "Associate Professor", "ankur@cumail.com", "MS", 35, "Chandigarh","AIT", "Active");
	// EE department Faculty
	t.root1 = t.insertion_Faculty_EE(t.root1,2001,"Kumar", "sharma", "5202", "Male", "0342-1238567", "HOD & Professsor", "kumar@cumail.com", "PHD", 45, "Model  town india", "LHR", "Active");
	t.root1 = t.insertion_Faculty_EE(t.root1,2002,"Kunal", "singh", "5203", "Male",   "0300-5671234","Professor", "kunal@cumail.com", "PHD", 55, "west town Chandigarh","LHR", "Active");
	t.root1 = t.insertion_Faculty_EE(t.root1,2003,"Pradeep","kumar", "5204","Female", "0301-1234789","Professor", "pradeep@cumail.com", "PHD", 40, "Main Chandigarh", "LHR","Leave");
	t.root1 = t.insertion_Faculty_EE(t.root1, 2004,"Aditya", "shah", "5206","Male","0313-0000567","lab Engineer","aditya@cumail.com","BS-CS", 30, "Model Town Chandigarh","LHR", "Active");
	// Humanities Department Faculty
	t.root2 = t.insertion_Faculty_Humanities(t.root2, 3001, "Ishita", "Tiwari", "6202", "Female", "0300-5269434","HOD", "Ishita@cumail.com", "PHD", 45, "Chandigarh", "LHR", "Active");
	t.root2 = t.insertion_Faculty_Humanities(t.root2, 3002, "Simran", "jha", "6203", "Female", "0322-5267448","Associate Professor","simran@cumail.com","PHD", 40, "Chandigarh", "LHR", "Leave");
	// for Library staff
	t.root3 = t.insertion_Faculty(t.root3, 6001, "Manoj", "Dey", "17301", "Male", "0308-5733828", "Manager", "manoj@cumail.com", "MS", 40, "Chandigarh, AIT", "AIT", "Active");
	// for admin staff
	a.root6 = a.insertion_Faculty(a.root6,7001,"Ajey","Nagar","17301","male","0308-5733898","Manager","ajey@cumail.com","CS",21,"LHR","AIT","Active");
	// for board of governers
	w.insertion_List1(11, "Dr. Kunal sharma", "17302", "male", "Rector-Chairman", "kunal@cumail.com");
	w.insertion_List1(10, "Mr. Ashok kumar", "35707", "male", "Members","ashok@cumail.com");
	// for board of trustees
	w.insertion_List2(20, "Amar","35202", "male","members", "amar@cumail.com");
	// for officers of university
	w.insertion_List3(30,"Kamlesh","17301","male", "members","kamlesh@cumail.com");
	// Styling front page
	cout<<"\n \n \n \n \n \n "<<endl;
	cout<<"\t \t \t \t ..............................................."<<endl;
